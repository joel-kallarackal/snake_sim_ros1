...
class PyBulletRosWrapper:
    def __init__(self):
        ...
        self.urdf_spawn_pose = [0.235, -1.68, 0.40]
        self.urdf_spawn_orientation = p.getQuaternionFromEuler([0, np.pi, np.pi/2])
    ...
    def load_urdf(self):
        ...
        self.robot_id = p.loadURDF(
            ...
            baseOrientation=self.urdf_spawn_orientation
        )
        (
        ...
        # Loop through all joints/links and set friction
    ...
    def load_terrain(self):
        ...
        ### Load Jungle Gym ###
        terrain_path = "/home/kallrax/biorobotics_lab/ros1_ws/src/snakelib_bullet/terrain/junglegym3.STL"

        # Create collision shape as concave mesh
        ...
        # Optionally create a visual shape (can also use the STL itself)
        ...
        orientation = p.getQuaternionFromEuler([np.pi/2, 0, 0])  # rotate 90° about X
        # Create the terrain body (static = mass=0)
